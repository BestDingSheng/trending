...
const GridItem = ({ repository }) => {
  const { language, owner, name, created_at, description, stargazers_count } =
    repository || {};
      ...
      <div className="grid-item-body">
        ...
        <div className="repo-header">
          ...
          >
            ...
            &middot; {moment(created_at).format('MMMM D, YYYY')}
          </p>
        </div>
        ...
        <div className="repo-footer">
          ...
          >
            <Star />
            {stargazers_count ? stargazers_count.toLocaleString() : 0}
          </a>
          <a
            className="muted-link d-inline-block mr-3"
